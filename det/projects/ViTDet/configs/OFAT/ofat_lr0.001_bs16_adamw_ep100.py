...
dataloader.train = L(build_detection_train_loader)(
    ...
    total_batch_size=16,  # VARIED BATCH SIZE
    num_workers=4,
)
...
# Batch size: 16
# Iterations per epoch = 1271 / 16 ≈ 80
# Total iterations = 80 * 100 = 8000

ITERS_PER_EPOCH = 80
EPOCHS = 100  # BASELINE EPOCHS
train.max_iter = ITERS_PER_EPOCH * EPOCHS  # 8000 iterations
...
# Output directory
train.output_dir = "./work_dirs/ofat_lr0.001_bs16_adamw_ep100"
