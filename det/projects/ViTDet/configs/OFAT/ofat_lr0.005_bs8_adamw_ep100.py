"""
OFAT LR Variation: Fine-tuning ViM-Tiny for Head Detection
Parameters:
- Learning Rate: 0.005 (VARIED)
...
# Output directory
train.output_dir = "./work_dirs/ofat_lr0.005_bs8_adamw_ep100"
...
optimizer.lr = 0.005  # VARIED LEARNING RATE (5e-3)
