...
# Calculate iterations for 150 epochs
# Dataset: 1271 training images
# Batch size: 8
# Iterations per epoch = 1271 / 8 ≈ 159
# Total iterations = 159 * 150 = 23850

ITERS_PER_EPOCH = 159
EPOCHS = 150  # VARIED EPOCHS
train.max_iter = ITERS_PER_EPOCH * EPOCHS  # 23850 iterations
...
# Output directory
train.output_dir = "./work_dirs/ofat_lr0.001_bs8_adamw_ep150"
