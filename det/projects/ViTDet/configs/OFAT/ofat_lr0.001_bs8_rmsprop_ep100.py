"""
OFAT Optimizer Variation: Fine-tuning ViM-Tiny for Head Detection
Parameters:
- Learning Rate: 0.001 (baseline)
- Batch Size: 8 (baseline)
- Optimizer: RMSProp (VARIED)
- Epochs: 100 (baseline)
- Backbone: FROZEN
...
train.max_iter = ITERS_PER_EPOCH * EPOCHS  # 15900 iterations
...
# Output directory
train.output_dir = "./work_dirs/ofat_lr0.001_bs8_rmsprop_ep100"
...
optimizer = L(torch.optim.RMSprop)(  # VARIED OPTIMIZER
    params=L(get_default_optimizer_params)(
        base_lr=0.001,
        weight_decay_norm=0.0,
    ),
    lr=0.001,  # BASELINE LEARNING RATE (1e-3)
    alpha=0.99,
    eps=1e-8,
    weight_decay=1e-4,
    momentum=0.0,
