"""
OFAT Batch Size Variation: Fine-tuning ViM-Tiny for Head Detection
Parameters:
- Learning Rate: 0.001 (baseline)
- Batch Size: 32 (VARIED)
...
dataloader.train = L(build_detection_train_loader)(
    ...
    total_batch_size=32,  # VARIED BATCH SIZE
    num_workers=4,
)
...
# Batch size: 32
# Iterations per epoch = 1271 / 32 ≈ 40
# Total iterations = 40 * 100 = 4000

ITERS_PER_EPOCH = 40
EPOCHS = 100  # BASELINE EPOCHS
train.max_iter = ITERS_PER_EPOCH * EPOCHS  # 4000 iterations
...
# Output directory
train.output_dir = "./work_dirs/ofat_lr0.001_bs32_adamw_ep100"
